...
-- 3. Row Level Security (RLS) ayarları - Herkes okuyabilir, sadece authenticated kullanıcılar yazabilir
-- Not: Admin paneli API route üzerinden çalıştığı için RLS'yi kapatıyoruz
-- Alternatif: Service role key kullanarak admin işlemlerini yapabilirsiniz
