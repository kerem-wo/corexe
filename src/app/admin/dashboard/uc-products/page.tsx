  ...
  async function save() {
    ...
    try {
      ...
      if (res.ok && result.success) {
        console.log('✅ Veritabanına kaydedildi:', data.ucProducts.length, 'UC ürünü');
        ...
        setTimeout(async () => {
          try {
            ...
            console.log('✅ Veritabanı doğrulandı:', verifiedData.ucProducts?.length, 'UC ürünü');
            setData(verifiedData);
            setMessage(`✅ Kaydedildi ve doğrulandı! ${verifiedData.ucProducts?.length || 0} UC ürünü veritabanında. Ana sayfa anında güncellenecek.`);
          } catch (err) {
